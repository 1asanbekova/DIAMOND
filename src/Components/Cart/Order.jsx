    ...
    <>
      ...
      <div className="cart-order">
        <div className="cart-order-box">
          ...
          <div className="order-subtotal ">
            {" "}
            <p>Estimated Total ${cart.totalPrice}</p>
          </div>
        </div>
        ...
        <div align="center" className="order-paypal2">
          <img
            className="paypalimg3"
            src="https://cdn-icons-png.flaticon.com/512/6124/6124998.png"
            alt=""
          />
        </div>
        <div align="center" className="order-paypal3">
          <img
            className="paypalimg3"
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWha47K53sgZlkkI4JG4aoteAWmevS5IpVwv3WdT6tiIrVQNYBQXVVWJq2MteLuoiG54M&usqp=CAU"
            alt=""
          />
        </div>
      </div>
